...
<img width="1920" alt="完全に理解した_かみあぷり.006.png (2.9 MB)" src="/img/407/50d741ff-b7ba-4778-98a5-6afb65fe1cf2.webp">
...
<img width="1920" alt="完全に理解した_かみあぷり.007.png (3.0 MB)" src="/img/407/9f238355-e4bf-48cb-a803-8d72f26125ef.webp">
以下の画像は実際のアプリの画面です。  
紙を破いたと判断されると 付箋 に書かれている内容が実行され、ログが追加されます。また右側の2本の棒で認識状況がわかるようになっています。
<img width="1920" alt="完全に理解した_かみあぷり.009.png (2.5 MB)" src="/img/407/94130707-0f99-4eb3-800b-1245ee3e5f0a.webp">
